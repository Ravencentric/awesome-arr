...
- [Managarr](https://github.com/Dark-Alex-17/managarr) - A TUI and CLI to help you manage all your Servarrs. The TUI is for an in-terminal UI for interacting with your Servarrs, and the CLI lets you write additional scripts and automations for your Servarrs more easily.
