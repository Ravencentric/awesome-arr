...
- [Nixarr](https://github.com/rasmus-kirk/nixarr) - A Nixos module that helps setup and manage a media server stack natively in Nixos. Supports a lot of *Arrs, Jellyfin, Plex, Audiobookshelf, has both Usenet and Torrent modules and has built-in VPN-support.
...
- [Invitarr](https://github.com/Sleepingpirates/Invitarr) - A chatbot that invites discord users to plex.
